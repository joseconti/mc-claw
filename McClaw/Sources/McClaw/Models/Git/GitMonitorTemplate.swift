...
struct GitMonitorTemplate: Identifiable, Sendable {
    ...
    static let allTemplates: [GitMonitorTemplate] = [
        GitMonitorTemplate(
            id: "pr-reviewer",
            name: String(localized: "git_monitor_pr_reviewer", bundle: .appModule),
            description: String(localized: "git_monitor_pr_reviewer_desc", bundle: .appModule),
        ...
        GitMonitorTemplate(
            id: "ci-watcher",
            name: String(localized: "git_monitor_ci_watcher", bundle: .appModule),
            description: String(localized: "git_monitor_ci_watcher_desc", bundle: .appModule),
            icon: "gearshape.2",
        ...
        GitMonitorTemplate(
            id: "stale-branches",
            name: String(localized: "git_monitor_stale_branches", bundle: .appModule),
            description: String(localized: "git_monitor_stale_branches_desc", bundle: .appModule),
        ...
        GitMonitorTemplate(
            id: "security-scan",
            name: String(localized: "git_monitor_security_scan", bundle: .appModule),
            description: String(localized: "git_monitor_security_scan_desc", bundle: .appModule),
            icon: "lock.shield",
        ...
        GitMonitorTemplate(
            id: "activity-summary",
            name: String(localized: "git_monitor_activity_summary", bundle: .appModule),
            description: String(localized: "git_monitor_activity_summary_desc", bundle: .appModule),
            icon: "chart.bar",
        ...
        GitMonitorTemplate(
            id: "issue-triage",
            name: String(localized: "git_monitor_issue_triage", bundle: .appModule),
            description: String(localized: "git_monitor_issue_triage_desc", bundle: .appModule),
            icon: "circle.circle",
